...
//打开新的窗口  
// window.open(location.href,"makeful",   'fullscreen=yes,channelmode=yes,titlebar=no,toolbar=no,scrollbars=auto,resizable=no,status=no,copyhistory=no,location=no,menubar=no,width='+x+',height='+y);  
// window.close();//关闭当前窗口  
// 
// 
...
//     var x = screen.availWidth;  
//     var y = screen.availHeight;  
//     window.open(location.href,'FullWnd','scrollbars=no,fullscreen=yes,channelmode=yes,titlebar=no,toolbar=no,resizable=no,status=no,copyhistory=no,location=no,menubar=no,top=0,width='+x+',height='+y+'');    
