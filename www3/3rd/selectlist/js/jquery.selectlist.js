            ...
            if(that.settings.enable){
                ...
                $(selectID)
                    .click(function(event){
                        ...
                        // 判断鼠标箭头的方向
                        if($(this).children('.select-list').css('display') == 'block'){
                            // 设置模拟选择列表向下箭头样式
                            $(selectID).children('.select-down').css({
                                top: that.setStyleProperty((that.settings.height - that.settings.triangleSize)/2) + 'px',
                                'border-width': that.setStyleProperty(that.settings.triangleSize) + 'px',
                        ...
                        }else if($(this).children('.select-list').css('display') == 'none'){
                            //设置模拟选择列表向下箭头样式
                            $(selectID).children('.select-down').css({
                                top: that.setStyleProperty((that.settings.height - that.settings.triangleSize)/4) + 'px',
                                'border-width': that.setStyleProperty(that.settings.triangleSize) + 'px',
                                'border-color':' transparent transparent '+that.setStyleProperty(that.settings.triangleColor)+' transparent'
                            });
                        }
